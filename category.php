    ...
    <div id="innercontainer" class="container-fluid">
        ...
        <div id="row" class="row">
            ...
            <div class="col-sm-10 col-sm-offset-1 container-main" id="containermain">
                    <div id="cotegoriesList"><img id="loadingImgCat"src="img/ajax-loader.gif" style="padding-left:43%;padding-top: 12%;"class="hide"></img></div>
                    <div id="issuesList"> <img id="loadingImg"src="img/ajax-loader.gif" style="padding-left:43%;padding-top: 12%;"class="hide"></img></div> 
            </div>
