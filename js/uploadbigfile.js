var countForFile=0;
var filenameRandom="data";
function uploadchange() {
            filenameRandom=Math.floor((Math.random() * 100000) + 1)+"-"+(document.getElementById('file').files[0].name);
...
window.BlobBuilder = window.MozBlobBuilder || window.WebKitBlobBuilder || window.BlobBuilder;
        ...
        uploadFile(window.uploadfilearray[window.uploadcounter],filenameRandom);
            }
            ...
            if (window.uploadfilearray.length > window.uploadcounter ){
              ...
              if(countForFile===0)
              {
                countForFile=countForFile+1;

              }

                uploadFile(window.uploadfilearray[window.uploadcounter],filenameRandom,document.getElementById('file').files[0].size);
