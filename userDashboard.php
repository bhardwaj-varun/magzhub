    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="containerOfMagazine" class="col-xs-12 col-sm-10 col-sm-offset-1 container-main ">
                <div id="magazinelist">
                     <img id="loadingImg1"src="img/ajax-loader.gif" style="padding-left:200px;padding-top: 100px;"class="hide"></img>
                </div>
                <div id="issueList">
                    <img id="loadingImg2"src="img/ajax-loader.gif" style="padding-left:200px;padding-top: 100px;"class="hide"></img>
                </div>
            </div>
        </div>
    </div>
